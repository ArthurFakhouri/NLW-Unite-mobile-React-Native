...
export function Credential({ data, onChangeAvatar, onShowQRCode }: CredentialProps) {
    ...
    return (
        <MotiView
            ...
            transition={{
                type: 'spring', damping: 20, rotateZ: {
                    damping: 15,
                    mass: 3,
                }
            }}
            ...
            <View className="bg-black/70 self-stretch items-center pb-6 border border-white/10 mx-3 rounded-2xl -mt-5">
                ...
                >
                    <View className="w-full flex-row items-center justify-between">
                        ...
                        <Text className="text-zinc-50 text-sm font-bold">#{data.id.toString().padStart(3, "0")}</Text>
                    </View>
                ...
                </ImageBackground>
                {
                    ...
                    <TouchableOpacity activeOpacity={0.9} onPress={onChangeAvatar}>
                        <Image source={{ uri: data.image }} className="size-36 rounded-full -mt-24" />
                    </TouchableOpacity>
                }
                {
                    !data.image &&
